...
<head>
    <meta charset="UTF-8">
    <title id="farrukh">  Karimov Farrukh Tojidinovich P3202 var:18204 </title>
...
<h2 id="farrukh" >Karimov Farrukh Tojidinovich P3202 var:18204</h2>
<table>
    <tr>
        <td id="left">
            <h3>
            ...
            <form method="POST" action="./check.php">
                Значение X : <input id="x_" type="text" placeholder="(-3,...,5)" name="x_">
                <label id="valid_x"> good x </label>
                <br/>
                Значение Y :
